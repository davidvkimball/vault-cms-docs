...
:::note
This plugin is currently in beta and installs via [BRAT](/plugins/brat/) rather than the official Obsidian community directory. Every other companion plugin is in the official directory, apart from the theme settings plugins that ship with Astro Modular and Axis.
:::
